 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();const zr=function(e=function(e="[DEFAULT]"){const t=Q.get(e);if(!t)throw te.create("no-app",{appName:e});return t}(),t){return ee(e,"database").getImmediate({identifier:t})}(function(e,t={}){if("object"!=typeof t){t={name:t}}const n=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),i=n.name;if("string"!=typeof i||!i)throw te.create("bad-app-name",{appName:String(i)});const s=Q.get(i);if(s){if(S(e,s.options)&&S(n,s.config))return s;throw te.create("duplicate-app",{appName:i})}const r=new W(i);for(const e of X.values())r.addComponent(e);const o=new ne(e,n,r);return Q.set(i,o),o}({apiKey:"AIzaSyA8-_6OlLLGP_kVPkHOHLCZK3jxs2ukfQI",authDomain:"chatapp-30a6b.firebaseapp.com",databaseURL:"https://chatapp-30a6b-default-rtdb.europe-west1.firebasedatabase.app/",projectId:"chatapp-30a6b",storageBucket:"chatapp-30a6b.appspot.com",messagingSenderId:"355675536288",appId:"1:355675536288:web:03d2ca1fafe06d787642c5"}));class Vr{constructor(e,t,n){this.id=e,this.name=t,this.message=n,this.displayChat()}displayChat(){const e=document.querySelector("#chat"),t=document.getElementById("name").value,n=document.createElement("div"),i=document.createElement("p"),s=document.createElement("p"),r=document.createElement("button");i.innerText=this.name+" says: ",s.innerText=this.message,n.className="div-child",n.id=this.id,r.innerText="X",r.className="delete",r.addEventListener("click",(()=>{console.log("Delete button is clicked!");Ar(Rr(zr,"/messages/"+this.id))})),t!=this.name&&(r.style.display="none"),n.append(i,s,r),e.append(n),document.body.append(e)}clearChat(){document.querySelector(`#${this.id}`).remove()}}const $r=Rr(zr,"/messages");let Yr=[];Wr($r,(e=>{const t=e.val();console.log(t),console.log(Object.keys(t).length),console.log(Object.keys(t)[0]),function(){const e=Object.values(t),n=Object.keys(t)[0];console.log(e);for(let t=0;t<e.length;t++);if(e.length>25){console.log("Du har mer än 25 meddelanden",e.length);Ar(Rr(zr,"/messages/"+n))}else console.log(e.length)}();for(const e of Yr)e.clearChat();Yr=[];for(const e in t)Yr.push(new Vr(e,t[e].name,t[e].message))}));document.querySelector("#add").addEventListener("click",(e=>{const t=document.querySelector("#name"),n=document.querySelector("#message");e.preventDefault();const i={name:t.value,message:n.value};n.value="";const s={};s[function(e,t){e=R(e),Ys("push",e._path),Bs("push",t,e._path,!0);const n=ir(e._repo),i=wn(n),s=Dr(e,i),r=Dr(e,i);let o;return o=null!=t?Mr(r,t).then((()=>r)):Promise.resolve(r),s.then=o.then.bind(o),s.catch=o.then.bind(o,void 0),s}($r).key]=i,Or($r,s)}));
//# sourceMappingURL=index.7da14656.js.map
